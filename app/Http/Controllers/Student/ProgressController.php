...
class ProgressController extends Controller
{
    ...
    public function statusReports()
    {
        ...
        // 2. Fetch All Evaluations for this Student's Proposal (via the Defense Matrix chain)
        $evaluations = DB::table('tbl_defense_evaluations')
            ...
            // Filter by the Student's ID (via Proposal)
            ->where('tbl_proposals.student_id', $student->id)
