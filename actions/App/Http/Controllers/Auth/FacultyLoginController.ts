...
/**
* @see \App\Http\Controllers\Auth\FacultyLoginController::create
...
/**
* @see \App\Http\Controllers\Auth\FacultyLoginController::destroy
...
const FacultyLoginController = { create, store, destroy }
