...
/**
* @see \App\Http\Controllers\Auth\StudentLoginController::create
...
/**
* @see \App\Http\Controllers\Auth\StudentLoginController::destroy
...
const StudentLoginController = { create, store, destroy }
