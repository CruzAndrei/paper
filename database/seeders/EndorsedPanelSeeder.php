...
class EndorsedPanelSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $schedules = DefenseMatrix::with([
            ...
            'endorsement.thesis.proposal.student.sectionAdviser.assignment'
        ])->get();
        ...
        foreach ($schedules as $schedule) {
            ...
            // Path: DefenseMatrix -> Endorsement -> Thesis -> Proposal -> Student -> SectionAdviser -> FacultyAssignment
            $adviserAssignment = $schedule->endorsement?->thesis?->proposal?->student?->sectionAdviser?->assignment;
